...
locals {
  ...
  cluster_endpoint           = (var.enable_private_nodes && length(google_container_cluster.primary.private_cluster_config) > 0) ? (var.deploy_using_private_endpoint ? google_container_cluster.primary.private_cluster_config.0.public_endpoint : google_container_cluster.primary.private_cluster_config.0.private_endpoint) : google_container_cluster.primary.endpoint
